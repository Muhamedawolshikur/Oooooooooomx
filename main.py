...
# ================= BOT CONFIG =================
BOT_TOKEN = "8896468531:AAGG-6Psr35XmWT33cu3Yev7y5hKDc_6drw" # የእርስዎን ቦት ቶክን ብቻ እዚህ ይተኩ
OWNER_ID = 8700421304       # የአስተዳዳሪው የቴሌግራም ID
...
# በ Render ላይ ያለምንም API HASH በቶክን ብቻ የሚሰራው ዋናው ቦት
...
# ================= UNIVERSAL RUNNER (ማንኛውንም ቦት ያነባል) =================
def run_script_sync(user_id, file_path):
    # ተጠቃሚዎች የጫኑትን የትኛውንም የቦት ላይብረሪ (Pyrogram ጭምር) እዚህ ጋር ያስነሳል
